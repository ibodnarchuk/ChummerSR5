...
public class SpellList implements UpdateInterface {
    ...
    public SpellList(View rootView) {
        SpellList.rootView = rootView;
    ...
    private void addSpell(Spell newSpell, int pointsUsed) {
        if (newSpell != null) {
            ...
            pointHistoryForSpells.add(pointsUsed);
        ...
        if (spellSelected != null) {
            ...
            for (int i = 0; i < displayedSpells.size(); i++) {
                ...
                if (displayedSpells.get(i).getName() == spellSelected.getName()) {
                    int pHistory = pointHistoryForSpells.get(i);
                    ...
                    pointHistoryForSpells.remove(i);
                    break;
                }
            }
                ...
                if (add) {
                    builder.setPositiveButton("Buy", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (displayedSpells.size() < ShadowrunCharacter.getCharacter().getAttributes().getMagic() * 2) {
